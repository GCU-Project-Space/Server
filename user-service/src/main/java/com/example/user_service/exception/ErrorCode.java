...
public enum ErrorCode {
    ...
    // === 유저 서비스 에러 ===
    USER_NOT_FOUND(2007, HttpStatus.NOT_FOUND, "사용자를 찾을 수 없음"),
    USER_NOT_FOUND_BY_EMAIL(2007, HttpStatus.NOT_FOUND, "존재하지 않는 이메일"),
    DUPLICATE_EMAIL(2010, HttpStatus.CONFLICT, "이미 사용중인 이메일"),
    INVALID_EMAIL_TYPE(2002, HttpStatus.BAD_REQUEST, "이메일 (.ac.kr)만 사용 가능"),
    INVALID_PASSWORD(2005, HttpStatus.BAD_REQUEST, "잘못된 비밀번호");
